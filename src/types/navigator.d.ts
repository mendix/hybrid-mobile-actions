...
interface CordovaCameraOptions {
    quality?: number;
    destinationType?: CordovaCameraDestinationType;
    sourceType?: CordovaCameraPictureSourceType;
    allowEdit?: boolean;
    encodingType?: CordovaCameraEncodingType;
    targetWidth?: number;
    targetHeight?: number;
    mediaType?: CordovaCameraMediaType;
    correctOrientation?: boolean;
    saveToPhotoAlbum?: boolean;
    popoverOptions?: CordovaCameraPopoverOptions;
    cameraDirection?: CordovaCameraDirection;
}

const enum CordovaCameraDestinationType {
    DATA_URL = 0,
    FILE_URI = 1,
    NATIVE_URI = 2
}

const enum CordovaCameraPictureSourceType {
    PHOTOLIBRARY = 0,
    CAMERA = 1,
    SAVEDPHOTOALBUM = 2
}

const enum CordovaCameraEncodingType {
    JPEG = 0,
    PNG = 1
}

const enum CordovaCameraMediaType {
    PICTURE = 0,
    VIDEO = 1,
    ALLMEDIA = 2
}

const enum CordovaCameraDirection {
    BACK = 0,
    FRONT = 1
}
...
interface CordovaContacts {
    ...
    find(
        fields: ReadonlyArray<ContactFieldType>,
...
interface Contact extends IContactProperties {
...
interface ContactFindOptions {
    ...
    desiredFields?: ReadonlyArray<ContactFieldType>;
